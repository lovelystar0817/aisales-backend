/**
 * AXA PH Skills Section Component
 * Shared component for rendering soft skills and knowledge skills sections
 */
...
interface AXAPHSkillsSectionProps {
  title: string;
  description: string;
  overallScore: number;
  maxScore: number;
...
const AXAPHSkillsSection: React.FC<AXAPHSkillsSectionProps> = ({
  title,
  description,
  overallScore,
  maxScore,
...
export default AXAPHSkillsSection;
