/**
 * Prudential Objection Handling - LAPR (Objection Handling) PDF Component
 * Displays Listen, Acknowledge, Probe, Reframe sections with scores and feedback
 */
...
interface PrudentialObjectionHandlingLAPRProps extends BaseSalesTechniqueProps {
  sections: Section[];
}

const PrudentialObjectionHandlingLAPR: React.FC<
  PrudentialObjectionHandlingLAPRProps
...
export default PrudentialObjectionHandlingLAPR;
