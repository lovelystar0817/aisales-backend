/**
 * Prudential Objection Handling - Sales Technique (3F) PDF Component
 * Displays Feel, Felt, Found sections with scores and feedback
 */
...
interface PrudentialObjectionHandlingSalesTechniqueProps
  extends BaseSalesTechniqueProps {
  sections: Section[];
}

const PrudentialObjectionHandlingSalesTechnique: React.FC<
  PrudentialObjectionHandlingSalesTechniqueProps
> = ({ overallScore, maxScore, description, sections, translations }) => {
  return (
    <div
      style={{
      ...
      >
        ...
        >
          ...
          <div style={{ flex: 1 }}>
            ...
            >
              {translations.salesTechnique || 'Sales Technique (3F)'}
            </h3>
            <p
              style={{
                fontSize: '14px',
...
export default PrudentialObjectionHandlingSalesTechnique;
