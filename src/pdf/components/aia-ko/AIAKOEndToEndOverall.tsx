...
interface AIAKOEndToEndOverallProps extends BaseOverallProps {
  overallScore: number;
  maxScore: number;
}

const AIAKOEndToEndOverall: React.FC<AIAKOEndToEndOverallProps> = ({
  overallScore,
  maxScore,
...
export default AIAKOEndToEndOverall;
