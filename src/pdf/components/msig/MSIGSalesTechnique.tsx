/**
 * MSIG Sales Technique Component
...
interface MSIGSalesTechniqueProps {
  overallScore: number;
  maxScore: number;
  description: string;
...
const MSIGSalesTechnique: React.FC<MSIGSalesTechniqueProps> = ({
  description,
  sections,
  translations,
}) => {
                      ...
                      (evaluation: any, evalIdx: number) => (
                        ...
                        >
                          ...
                          <div style={{ lineHeight: '1.6', flex: 1 }}>
                            <span
                              style={{
                                fontWeight: evaluation.pass ? 400 : 600,
                              }}
                            >
                              {evaluation.criteria}
                            </span>
