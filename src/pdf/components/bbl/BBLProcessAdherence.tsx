/**
 * BBL Process Adherence component
...
interface BBLProcessAdherenceProps extends BaseProductKnowledgeProps {
  sections: Section[];
}

const BBLProcessAdherence: React.FC<BBLProcessAdherenceProps> = ({
  overallScore,
  maxScore,
  description,
  sections,
...
export default BBLProcessAdherence;
