...
interface CustomProductKnowledgeProps extends BaseProductKnowledgeProps {
  sections: Section[];
}

const CustomProductKnowledge: React.FC<CustomProductKnowledgeProps> = ({
  overallScore,
  maxScore,
  description,
  sections,
...
export default CustomProductKnowledge;
