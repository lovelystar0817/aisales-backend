/**
 * Prudential assessment technical knowledge component for PDF
 * Shows product knowledge and operational knowledge sections
 */
...
interface PrudentialTechnicalKnowledgeProps {
...
const PrudentialTechnicalKnowledge: React.FC<
  PrudentialTechnicalKnowledgeProps
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            {translations.technicalKnowledge}
          </h3>
          <p
            style={{
              fontSize: '14px',
          ...
          >
            {description || translations.technicalKnowledgeDescription || ''}
          </p>
        </div>
                  ...
                  <div style={{ marginBottom: '1rem' }}>
                    ...
                    {item.completed.map((completedItem, compIdx) => (
                      ...
                      >
                        ...
                        <div style={{ lineHeight: '1.6' }}>{completedItem}</div>
                      </div>
                    ))}
                  </div>
                )}
