/**
 * HSBC Communication and Presence component
...
interface HSBCCommunicationAndPresenceProps extends BaseProductKnowledgeProps {
  sections: Section[];
}

const HSBCCommunicationAndPresence: React.FC<
  HSBCCommunicationAndPresenceProps
...
export default HSBCCommunicationAndPresence;
