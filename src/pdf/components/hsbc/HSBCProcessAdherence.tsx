/**
 * HSBC Process Adherence component
 * Dedicated component for Process Adherence section
 */
...
interface HSBCProcessAdherenceProps extends BaseSalesTechniqueProps {
  sections: Section[];
}

const HSBCProcessAdherence: React.FC<HSBCProcessAdherenceProps> = ({
  overallScore,
  maxScore,
  description,
  sections,
      ...
      >
        ...
        >
          ...
          <div style={{ flex: 1 }}>
            ...
            >
              {translations.processAdherence || 'Process Adherence'}
            </h3>
            <p
              style={{
                fontSize: '14px',
...
export default HSBCProcessAdherence;
