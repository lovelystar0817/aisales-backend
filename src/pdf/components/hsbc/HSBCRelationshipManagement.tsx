/**
 * HSBC Relationship Management component
 * Dedicated component for Relationship Management section
 */
...
interface HSBCRelationshipManagementProps extends BaseSalesTechniqueProps {
  sections: Section[];
}

const HSBCRelationshipManagement: React.FC<HSBCRelationshipManagementProps> = ({
  overallScore,
  maxScore,
  description,
  sections,
      ...
      >
        ...
        >
          ...
          <div style={{ flex: 1 }}>
            ...
            >
              {translations.relationshipManagement || 'Relationship Management'}
            </h3>
            <p
              style={{
                fontSize: '14px',
...
export default HSBCRelationshipManagement;
