/**
 * HSBC Advisory Technique component
...
interface HSBCAdvisoryTechniqueProps extends BaseSalesTechniqueProps {
  sections: Section[];
}

const HSBCAdvisoryTechnique: React.FC<HSBCAdvisoryTechniqueProps> = ({
  overallScore,
  maxScore,
  description,
  sections,
...
export default HSBCAdvisoryTechnique;
