/**
 * HSBC Representation component
 * Dedicated component for HSBC Representation section
 */
...
interface HSBCRepresentationProps extends BaseSalesTechniqueProps {
  sections?: Section[];
  why?: string;
  suggestion?: string;
  title?: string;
...
const HSBCRepresentation: React.FC<HSBCRepresentationProps> = ({
  overallScore,
  maxScore,
  description,
  sections,
      ...
      >
        ...
        <div style={{ flex: 1, minWidth: 0, padding: '0 40px 0 20px' }}>
          {sections && sections.length > 0 ? (
            ...
            // If no sections, render single why/suggestion
            <div
              style={{
                padding: '1rem 0',
              }}
...
export default HSBCRepresentation;
