/**
 * KT AXA Skills Section Component
...
interface KTAXASkillsSectionProps {
  title: string;
  description: string;
  overallScore: number;
  maxScore: number;
...
const KTAXASkillsSection: React.FC<KTAXASkillsSectionProps> = ({
  title,
  description,
  overallScore,
  maxScore,
...
export default KTAXASkillsSection;
