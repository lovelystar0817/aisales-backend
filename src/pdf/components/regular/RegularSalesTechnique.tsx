/**
 * Regular assessment sales technique component
 */
...
interface RegularSalesTechniqueProps extends BaseSalesTechniqueProps {
  sections: Section[];
}

const RegularSalesTechnique: React.FC<RegularSalesTechniqueProps> = ({
  overallScore,
  maxScore,
  description,
  sections,
...
export default RegularSalesTechnique;
