/**
 * Default competitive intelligence competitor data
 * Extracted from the main configuration for better organization
 */

import type { CompetitorTranslations } from '../../helpers.js';

/**
 * Pro Achiever 3.0 competitor translations across all supported languages
 */
export const proAchieverCompetitor: CompetitorTranslations = {
  en: {
